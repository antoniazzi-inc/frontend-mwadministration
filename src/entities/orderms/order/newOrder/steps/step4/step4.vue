  ...
  <div class="row" style="margin-top: 2em;">
    <div class="col-md-6">
      <form>
        ...
        <div class="form-group">
          <label class="form-control-label">{{$t('labels.invoiceDate')}}</label>
          <div class="date-input">
            <flat-pickr :config="dateConfig" v-model="invoiceDate" class="single-daterange form-control"></flat-pickr>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label class="control-label">{{$t('labels.scheduledOn')}}</label>
          <toggle-switch
            :on-text="$t('labels.yes')"
            :off-text="$t('labels.no')"
            :value.sync="isScheduled"></toggle-switch>
        </div>
        <div v-if="isScheduled" class="form-group">
