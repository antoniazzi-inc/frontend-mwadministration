<template>
  <div>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item" @click="currentTab = 'digital'" v-if="product.productType === 'DIGITAL'">
      ...
      <li class="nav-item" @click="currentTab = 'physical'" v-if="product.productType === 'PHYSICAL'">
      ...
      <li class="nav-item" @click="currentTab = 'digital'" v-if="product.productType === 'COURSE'">
      ...
      <li class="nav-item" @click="currentTab = 'features'">
      ...
      <li class="nav-item" @click="currentTab = 'promotions'">
      ...
      <li class="nav-item" @click="currentTab = 'payBtn'">
      ...
      <li class="nav-item" @click="currentTab = 'followUp'">
      ...
      <li class="nav-item" @click="currentTab = 'affiliates'">
      ...
      <li class="nav-item" @click="currentTab = 'payments'">
      ...
      <li class="nav-item" @click="currentTab = 'checkout'">
      ...
      <li class="nav-item" @click="currentTab = 'branding'">
