<template>
    <div class="element-box text-left">
      ...
      <div class="tab-content">
        <div :class="{'tab-pane': true, 'active': tabIndex === 0}" id="relFields" role="tabpanel" aria-labelledby="relFields-tab">
          <div class="row mt-4">
            <div class="col-md-6">
        ...
        <div :class="{'tab-pane': true, 'active': tabIndex === 1}" id="freeFields" role="tabpanel" aria-labelledby="freeFields-tab">
          <table class="table table-striped">
            <thead>
            <th>{{$t('labels.name')}}</th>
            <th>{{$t('labels.visible')}}</th>
        ...
        <div :class="{'tab-pane': true, 'active': tabIndex === 2}" id="companyAndTaxes" role="tabpanel" aria-labelledby="companyAndTaxes-tab">
          <form>
            <div class="row">
        ...
        <div :class="{'tab-pane': true, 'active': tabIndex === 3}" id="termsAndConditions" role="tabpanel" aria-labelledby="termsAndConditions-tab">
          <form>
            <div class="row mt-4">
              <div class="form-group col-md-6">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" @blur="checkForHttps" v-model="termsAndConditions.linkToConditions"/>
              </div>
              <div class="form-group col-md-6">
