            ...
            <div class="content-box">
                ...
                <div v-if="editMode || $props.addNewPayment">
                    <div class="row">
                        <div class="col-md-6">
                            <form>
                                <h3 class="title">{{$t('addEditPaymentSchedule')}}</h3>
                                <hr/>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">{{$t('period')}}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">{{$t('availableForCustomers')}}</label>
                        ...
                        <div class="col-md-6 scrollable-medium">
                            <form>
                                <button type="button" class="btn btn-outline-primary" @click.prevent="addNewPaymentScheduleOption"><i class="dashicons dashicons-plus"></i> {{$t('newPaymentScheduleOption')}}</button>
                                <hr/>
                                <div v-for="(option, key) in selectedPaymentSchedule.paymentScheduleOptions">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label class="form-control-label">{{$t('priceAmount')}}</label>
                                            <money v-model="option.price" class="form-control" name="priceAmount"  v-bind="money"></money>
                                        </div>
                                        <div class="form-group col-md-1 align-content-center">
                                            <i class="fa fa-trash cursor-pointer"  v-b-modal.removeEntityPaymentScheduleOption @click.prevent="prepareRemoveScheduleOption(option)"></i>
                                        </div>
                    ...
                    <div class="form-buttons-w text-right">
                        ...
                        <button class="btn btn-primary" @click.prevent="save">{{$t('vueadminApp.productmsPaymentSchedule.addPaymentSchedule')}}</button>
                    </div>
                </div>
            </div>
        </div>
