          ...
          <div>
            ...
            <div>
              <div role="form" class="form" v-if="editEvent">
                <h6 class="form-desc" v-if="selectedEvent && selectedEvent.id === null || selectedEvent && selectedEvent.id === undefined">{{$t('labels.createEvent')}}</h6>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="date-input">
                        <flat-pickr :config="dateConfigEnd" :class="{'single-daterange form-control': true}" v-model="eventEnd"/>
                      </div>
                  </div>
                </div>
                    ...
                    <div class="row p-0 m-0">
                      ...
                      <div class="col-md-8 p-0 m-0" v-if="!unlimitedSeats">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="number" v-model="selectedEvent.seats" :class="{'form-control': true}"/>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row" v-if="course.events && course.events.length > 0">
                <div class="col-md-12 form-group">
                  <table class="table table-striped">
                    ...
                    <tbody>
                    <tr v-for="(item, index) in course.events" :key="index">
                      <td>{{getMultiLangName(item.eventLanguages).name}}</td>
                      <td>{{getMultiLangName(item.eventLanguages).description}}</td>
                      <td>{{item.eventStart | formatDate}}</td>
                      <td>{{item.eventEnd | formatDate}}</td>
                ...
                <div class="col-md-12">
                  ...
                  <div class="row" v-if="editEvent">
                    <div class="col-md-12">
                      ...
                      <button type="button" id="save-entity-event" @click.prevent="saveNewEvent" class="btn btn-primary ml-2">
...
|| (course.courseLanguages.length && course.courseLanguages[0].name === '')" @click="save" class="btn btn-primary ml-2">
      ...
      <div class="col-md-6">
        <div class="row" v-if="editReservations">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-12 form-buttons-w text-left">
                <button type="submit" @click="fillSeats" class="btn btn-primary">
        ...
        <div class="row mt-4" v-if="editEvent">
          <div class="col-md-12">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
              <div class="element-wrapper">
                ...
                <div class="form-group">
                  <table class="table table-striped">
                    ...
                    <tr>
                      <th><span>{{$t('labels.relation')}}</span></th>
                      <th><span>{{$t('labels.signUp')}}</span></th>
                      <th><span>{{$t('labels.select')}}</span></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
            ...
            <div class="row">
              <div class="col-md-12 form-buttons-w text-left">
                ...
                <button type="submit" @click="assignSeats" class="btn btn-outline-success ml-2">
