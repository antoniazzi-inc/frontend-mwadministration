  ...
  <div class="col-md-9">
    <div>
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" @click="currentTab = 'quantityBased'" v-if="promotion.promotionType === 'QUANTITY'">
          <a :class="{'nav-link': true, 'active': currentTab === 'quantityBased'}" id="quantityBased-tab" data-toggle="tab"
        ...
        <li class="nav-item" @click="currentTab = 'affiliateBased'" v-if="promotion.promotionType === 'AFFILIATE'">
          <a :class="{'nav-link': true, 'active': currentTab === 'affiliateBased'}" id="affiliateBased-tab" data-toggle="tab"
        ...
        <li class="nav-item" @click="currentTab = 'personalCoupon'" v-if="promotion.promotionType === 'PERSONAL_COUPON' || promotion.promotionType === 'TEMPORARY_COUPON'">
          <a :class="{'nav-link': true, 'active': currentTab === 'personalCoupon'}" id="personalCoupon-tab" data-toggle="tab"
             href="#personalCoupon" role="tab" aria-controls="personalCoupon" aria-selected="false">{{$t('labels.personalCoupon')}}</a>
        </li>
    ...
    <div class="tab-content mt-3">
      ...
      <div :class="{'tab-pane': true, 'active': currentTab === 'usage'}" id="usage" role="tabpanel"
        ...
        <usage-tab-component :promotion="promotion"/>
      </div>
